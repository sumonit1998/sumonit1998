 ...
 */
class Player extends \App\Entity\Player implements \Doctrine\Persistence\Proxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        ...
        "\0".parent::class."\0".'listingPlayer' => [parent::class, 'listingPlayer', null],
        ...
        "\0".parent::class."\0".'teamPlayers' => [parent::class, 'teamPlayers', null],
        'id' => [parent::class, 'id', null],
        'listingPlayer' => [parent::class, 'listingPlayer', null],
        'name' => [parent::class, 'name', null],
        'price' => [parent::class, 'price', null],
        'status' => [parent::class, 'status', null],
        'surname' => [parent::class, 'surname', null],
        'teamPlayers' => [parent::class, 'teamPlayers', null],
    ];
